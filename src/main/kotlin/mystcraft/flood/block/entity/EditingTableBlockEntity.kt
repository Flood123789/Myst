...
class EditingTableBlockEntity(pos: BlockPos, state: BlockState) :
    BlockEntity(ModBlockEntities.EDITING_TABLE, pos, state),
    NamedScreenHandlerFactory,
    Inventory {

    private val inventory = DefaultedList.ofSize(17, ItemStack.EMPTY)

    override fun createMenu(syncId: Int, playerInventory: PlayerInventory, player: PlayerEntity): ScreenHandler =
        EditingTableScreenHandler(syncId, playerInventory, this)

    override fun getDisplayName(): Text = Text.translatable("block.mystcraft-reforged.editing_table")
