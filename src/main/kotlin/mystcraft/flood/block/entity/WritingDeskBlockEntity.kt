...
class WritingDeskBlockEntity(pos: BlockPos, state: BlockState) :
    BlockEntity(ModBlockEntities.WRITING_DESK, pos, state),
    ...
    override fun createMenu(syncId: Int, playerInventory: PlayerInventory, player: PlayerEntity): ScreenHandler =
        WritingDeskScreenHandler(syncId, playerInventory, this)

    override fun getDisplayName(): Text = Text.translatable("block.mystcraft-reforged.writingdesk")
